...
function ProjectCard({ project }: { project: (typeof projects)[0] }) {
  ...
  return (
    <div className="h-full w-full flex items-end justify-center relative overflow-hidden">
      <div
        className={
          "w-[98%] h-[98%] hover:size-full transition-all ease-in-out duration-500 rounded-xl" +
          " py-5 px-6 pb-0 border-[0.5px] border-white/20 bg-transparent cursor-pointer relative" +
          " bg-zinc-950/10 backdrop-blur-xl flex flex-col justify-between items-center gap-4"
        }
      >
        ...
        <Image
          className="group w-[90%] rounded-t-xl object-contain object-top"
